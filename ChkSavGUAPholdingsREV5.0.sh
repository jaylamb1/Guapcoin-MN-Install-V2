...
do
  ...
  echo "" >> $SnapshotFilename
  temp_MNs_data="\n'"$tempLabel"'             <https://guapexplorer.com/#/address/'"$i"'|'"$i"'>                '"$tempVar"'"
