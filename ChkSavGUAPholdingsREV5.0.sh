...
if [[ $TimeElapsedHr > '0' ]]; then
  ...
  EarnRateVarUSD="$EarnRateVarUSD            $GUAPUSDearnRateH USD/hour"
fi
...
if [[ $TimeElapsedMin > '0' ]]; then
  ...
  EarnRateVarUSD="$EarnRateVarUSD  $GUAPUSDearnRateM USD/min"
fi
