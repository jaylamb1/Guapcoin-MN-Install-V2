...
()/|___|\()
|_|_|
/_|_\  ----------- MASTERNODE REFRESH v2.3.2 ------------+
|                                                        |
|    This script will refresh the MN of your choice.     |
|    This script is compatible with GUAP V2.3.2 only.    |
|                                                        |
...
rm -rf /home/guapadmin/.guapcoin$MNID/bootstrap.zip 2> /dev/null

cd /home/guapadmin/.guapcoin$MNID/ && wget https://github.com/guapcrypto/Guap-v2.3.2-MN/releases/download/v2.3.2/bootstrap.zip
cd /home/guapadmin/.guapcoin$MNID/ && unzip bootstrap.zip

rm -rf /home/guapadmin/.guapcoin$MNID/bootstrap.zip
...
addnode=45.63.25.141" >> ~/.guapcoin$MNID/guapcoin.conf
